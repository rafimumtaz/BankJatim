...
<div class="bg-white rounded-2xl shadow-lg p-4 flex items-center gap-3 hover:scale-105 transition transform duration-300 cursor-pointer group min-w-[180px]">
